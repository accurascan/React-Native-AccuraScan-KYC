...
export default function ResultScreen({ route }){
  ...
  const [isPopupVisible, setPopupVisible] = React.useState(true);
  var PassportNo = "";
  var DOB = "";
  var DOE = "";
  ...
  if (result.hasOwnProperty('face')) {
    ...
    PassportNo = result.mrz_data["Document No."]
    DOB = result.mrz_data["Date of Birth"]
    DOE = result.mrz_data["Date of Expiry"]
  }
