...
class LVController: UIViewController,LivenessData,FacematchData
{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if isLiveness{
            ...
            if livenessConfig["setEnableFaceMovement"] != nil {
                let val = (livenessConfig["setEnableFaceMovement"] as? Bool)!
              liveness.enableFaceMovement(val)
            }else{
              liveness.enableFaceMovement(false)
            }
            
            if livenessConfig["setEnableOralVerification"] != nil {
                let val = (livenessConfig["setEnableOralVerification"] as? Bool)!
              liveness.enableOralVerification(val)
            }else{
              liveness.enableOralVerification(false)
            }
