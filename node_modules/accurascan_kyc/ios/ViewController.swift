...
//            lblOCRMsg.font = UIFont(name: accuraErrorCode["fontName"] as! String, size: CGFloat(lblTextSize))
        ...
        if status == .authorized {
            ...
            let alert = UIAlertController(title: "Alert!", message: "It looks like your privacy settings are preventing us from accessing your camera.", preferredStyle: .alert)
...
//        print("\(shareScanningListing)")
      ...
      if let docLivenessFront =  shareScanningListing["Document Liveness"] as? String {
        mrzData["Document Liveness Front"] = docLivenessFront
      }
      if let docLivenessBack =  shareScanningListing["Document Back Liveness"] as? String {
        mrzData["Document Liveness Back"] = docLivenessBack
      }
